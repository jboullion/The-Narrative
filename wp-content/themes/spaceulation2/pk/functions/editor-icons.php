...
// editor hooks	
add_action('admin_enqueue_scripts', 'sp_editor_icons_scripts');
//add_filter('mce_css', 'sp_editor_icons_css');
add_filter('mce_external_plugins', 'sp_editor_icons_plugin');
add_filter('mce_buttons', 'sp_editor_icons_button');

// load scripts
function sp_editor_icons_scripts() {
...
function sp_editor_icons_css($css) {
	if(!empty($css)) { $css .= ','; }
...
// editor plugin
function sp_editor_icons_plugin($plugins) {
	//$plugins['sp_icon'] = get_template_directory_uri().'/pk/misc/pk-editor-icons.js';
...
// editor button
function sp_editor_icons_button($buttons) {
	//$buttons[] = 'sp_icon_list';

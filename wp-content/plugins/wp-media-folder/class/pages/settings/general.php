...
<div id="advanced" class="tab-content">
    <div class="content-box content-wpmf-advanced">
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                <input type="hidden" name="status_menu_bar" value="0">
                <label data-alt="<?php esc_html_e('Show the number of attachments waiting to be processed in the admin menu bar. To prevent PHP timeout errors during attachment moving, the process is done asynchronously in background.', 'wpmf'); ?>"
                       class="ju-setting-label text"><?php esc_html_e('Show status menu bar', 'wpmf') ?></label>
                <div class="ju-switch-button">
                    <label class="switch">
                        <input type="checkbox" name="status_menu_bar"
                               value="1"
                            <?php
                            if (!empty($status_menu_bar)) {
                                echo 'checked';
                            }
                            ?>
                        >

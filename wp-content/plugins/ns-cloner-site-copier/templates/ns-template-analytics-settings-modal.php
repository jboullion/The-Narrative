...
<div class="ns-cloner-extra-modal load" id="analytics-settings">
    <div class="ns-cloner-extra-modal-content">
        <h3><?php esc_html_e( 'NS Cloner Statistics', 'ns-cloner' ); ?></h3>
        <p>
            ...
            But you have full control over this and can update it at any time from the Cloner Logs/Status page.', 'ns-cloner' ); ?>
        </p>
        <p>
            <?php esc_html_e( 'By default NO stats are shared - are you willing to Opt-In?', 'ns-cloner' ); ?>
        </p>

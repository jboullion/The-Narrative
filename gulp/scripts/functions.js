 ...
 */
function spTemplateEngine(tpl, data) {
	for(var key in data){
 ...
 * usage: str.spCleanNumber()
 */
String.prototype.spCleanNumber = function() {
 ...
 * usage: floatvalue.spFormatMoney(0, '.', ',');
 */
Number.prototype.spFormatMoney = function(c, d, t){
	var n = this, 
 ...
 */
function spRound(value, decimals) {
